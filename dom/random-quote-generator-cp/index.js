...
let quote = document.querySelector('#random-quote') // element untuk menampilkan quote
let author = document.querySelector('.author') // element untuk menampilkan author
let citation = document.querySelector('.citation') // element untuk menampilkan citation
let year = document.querySelector('.year') // element untuk menampilkan year
let button = document.querySelector('#generate-btn') // tombol untuk melakuan generate random quote
...
function getQuote(quotes) {
	// TODO: answer here
	let rand = Math.floor(Math.random() * quotes.length) // get random index from 0 to 10
	// get random quotes
	return quotes[rand]
}
...
function displayQuote() {
	// TODO: answer here
	// getQuote(quotes)
	let data = getQuote(quotes)
	
	quote.innerText = data.quote
	author.innerText = data.author

	// check data with citation
	if(data.citation != null)
	{
		citation.innerText = data.citation
	}
	else
	{
		citation.innerText = ""
